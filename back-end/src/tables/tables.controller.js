 ...
 */
 async function validateData(req, res, next) {
  ...
  /**
   * Checks if all required information for the body is correct.
   */
...
/**
 * Checks if the seat request is allowed.
 */
...
/**
 * Validates, finds, and stores based off of reservation ID.
 */
...
/**
 * Validates, finds, and stores based off of the table ID.
 */
