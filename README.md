...
This project has unit and integration tests. You have seen unit and integration tests in previous projects.
...
Once you have all user stories complete, you can run all the tests using the `npm test` command.
